...
public class StatisticsController {
         ...
         try {
            switch(switcher.getValue()){
                    ...
                    createTable();
                            ...
                            while(rs.next()){ 
                                ...
                                for (Calendar c : l) {
                                    ...
                                    BigDecimal bd = new BigDecimal((double) days*100 / (double) c.getActualMaximum(Calendar.DAY_OF_MONTH)).setScale(2, BigDecimal.ROUND_HALF_EVEN);
                ...
                case("Usage: Per Month and Year (Chart)"):{
                            ...
                            lineChart.getStylesheets().add("com.example.hotelmanagement.chart.css"); 
    ...
    private void createTable(){
        if (table == null){
            ...
            table = new TableView<>();
            table.getStylesheets().add("com.example.hotelmanagement.table.css");   
